    ...
    return (
        <>
            <View style={{ flex: 1, backgroundColor: Colors.primaryColor }}>
                ...
                >
                    {/* et à l'adresse mail suivante <Text style={{ fontFamily: "mons-b", color: Colors.primaryColor }}>{u && u['email']}</Text> */}
                    <View style={{ borderTopEndRadius: Dims.bigradius, borderTopStartRadius: Dims.bigradius, backgroundColor: Colors.whiteColor, height: Dims.height, marginTop: Dims.smallradius }}>
                        <View style={{ width: "85%", alignSelf: "center", marginTop: Dims.bigradius }}>
                            <Text style={{ fontFamily: "mons-e", textAlign: "center" }}>Nous venons d'envoyer un code de vérification au numéro de téléphone <Text style={{ fontFamily: "mons-b", color: Colors.primaryColor }}>{u && u['phone']}</Text></Text>
                        </View>
                        <View style={{ width: "85%", alignSelf: "center", marginTop: 5 }}>
                            <View style={{ width: "100%", height: 75, flexDirection: "column" }}>
                                <View style={[inputGroup.iconcontainer, { backgroundColor: "lime", height: 100, width: 100, alignSelf: "center" }]}>
