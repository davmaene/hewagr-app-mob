...
export const AbonnemetConseilAgricoleScreen = ({ navigation, route }) => {
    ...
    const handlePayement = async ({ payementMethode }) => {
        ...
        onRunExternalRQST({
            method: "POST",
            url: `/collectors/collector/newsouscriptionconseil`,
            data: {
                "phone": `+243${remove_0_ToPhone_Number({ phone })}`,
                "language": lg,
                "products": [
                    ...selectedItems
                ],
            ...
            if(done){
                ...
                console.log(" Message from server is => ", done['data']['message']);
                switch (s) {
                    case 200:
                        setisloading(false);
                        refc.current.tip({
    ...
    return(
        <>
            <Title 
                ...
                title={"Abonnement conseils agricoles"} 
            ...
            <View style={{ flex: 1, backgroundColor: Colors.whiteColor, paddingTop: Dims.borderradius }}>
                ...
                >
                    <View style={{width: "90%", alignSelf: "center", paddingVertical: 10}}>
                        <Text style={{ paddingBottom: 6, marginTop: 0, fontFamily: "mons", fontSize: Dims.titletextsize }}>Abonenment | <Text style={{ color: Colors.primaryColor }}>les conseils agricoles</Text></Text>
                        ...
                        <View style={{width: "100%", height: 65, flexDirection: "column", marginTop: 15}}>
                            ...
                            <View style={{ width: "100%", minHeight: 65, flexDirection: "column", marginTop: 0, position: "absolute", top: 25, zIndex: 28972 }}>
                                <MultiSelect
                                    ...
                                    submitButtonText='Aouter les produits séléctionés'
                                    styleRowList={{ 
                                        paddingVertical: 4,
                                        marginTop: 2,
                ...
                title={
                    {
                        ...
                        text: title.toString().length > 0 ? title : "Connectivité"
                    }
                } 
                subTitle={
                    { 
